...
<body>
    ...
    <div id="bloge_content">
        <div class="details">
            <i class="fa-solid fa-circle-user"></i><span><?php echo e($blog->name); ?></span><span><?php echo e(date('d F, Y', strtotime($blog->created_at))); ?></span>
        </div>
        <div class="title up_animatedElement up_hidden"><?php echo e($blog->title); ?></div>
        <div class="image up_animatedElement up_hidden">
            <img src="<?php echo e(asset($blog->image_path)); ?>" class="img-fluid" alt="">   
        </div>
        <div class="text up_animatedElement up_hidden"><?php echo $blog->continue; ?></div>
    </div>
    <footer>
            <!-- Footer Area Start -->
...
</html><?php /**PATH C:\Users\OVERLORD\Desktop\PFE\app\ai-toolbox\resources\views/blog.blade.php ENDPATH**/ ?>