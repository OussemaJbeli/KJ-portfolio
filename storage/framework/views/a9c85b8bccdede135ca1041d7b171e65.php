...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="#about" class="navbar-brand d-block d-lg-none">
            <h1 class="text-primary fw-bold m-0">Kais</h1>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-between py-4 py-lg-0" id="navbarCollapse">
            ...
            <a href="#experience" class="navbar-brand bg-secondary py-3 px-4 mx-3 d-none d-lg-block">
                <h1 class="text-primary fw-bold m-0">Exp</h1>
            </a>
            <div class="navbar-nav me-auto py-0">
                <a href="#project" class="nav-item nav-link">Projects</a>
                <a href="#blog-section" class="nav-item nav-link">Blogs</a>
    ...
    <!-- Header Start -->
    <div class="container-fluid mt-0" id="home">
        <div class="container home_container wow fadeInUp" data-wow-delay="0.3s">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0 side-info">
                    <h3>Hello I'm</h3>
                    <h1 class="name">Jlassi Kais</h1>
                    <div class="typing">
                    ...
                    <p>I excel at crafting elegent gigital experience and I am proficient in various programing languages and technologies</p>
                    <div class="buttons">
        ...
        <div class="bgc1" id="bgc1">
            <img src="/img/landingPage/city.png" alt="" id="bg1">
        </div>
        <div class="animation_icons">
            <div class="sun" id="sun">
                <img src="/img/landingPage/sun.png" alt="">
            </div>
            <div class="forret">
                <div class="f_left" id="left">
                    <img src="/img/landingPage/left.png" alt="">
                </div>
                <div class="f_rigth" >
                    <img src="/img/landingPage/right.png" alt="" id="rigth">
                </div>
            </div>
        </div>
        <div class="frant" id="frant">
            <img src="/img/landingPage/ground.png" alt="">
        </div>
    </div>
    <!-- Header End -->

    <!-- counter End -->
    <div class="container-xxl ftco-counter" id="section-counter">
      <div class="container">
        <div class="row wow fadeInUp" data-wow-delay="0.1s" id="numbers_panel">
          <div class="counter_val justify-content-center counter-wrap ftco-animate" data-aos="zoom-in" data-aos-delay="100">
            <div class="cardCount">
              <div class="part1">
                <div class="icon">
                ...
                <strong class="number" id="number1" data-toggle="counter-up">78</strong>
              </div>
              <span>Project Complete</span>
            </div>
          </div>
          <div class="counter_val justify-content-center counter-wrap ftco-animate" data-aos="zoom-in" data-aos-delay="200">
            <div class="cardCount">
              <div class="part1">
                <div class="icon">
                ...
                <strong class="number" id="number2" data-toggle="counter-up">788</strong>
              </div>
              <span>Happy Clients</span>
            </div>
          </div>
          <div class="counter_val justify-content-center counter-wrap ftco-animate" data-aos="zoom-in" data-aos-delay="300">
            <div class="cardCount">
              <div class="part1">
                <div class="icon">
                ...
                <strong class="number" id="number3" data-toggle="counter-up">8</strong>
              </div>
    ...
    <div class="container-xxl py-6" id="about">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp first_part">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <img class="img-fluid rounded" src="/img/landingPage/user.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="experience" id="experience">
            <div class="container">
                <header>
                    <h1 class="display-5 text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Working Experience</h1>
                </header>
                <div class="timeline">
    ...
    <!-- Blogd Start -->
    <div class="container-fluid py-5 my-5 blog-section" id="blog-section">
        <div class="container">
            <h1 class="display-5 text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Blogs</h1>
            <div class="row justify-content-center">
                <div class="blogs_cards">
                    <div class="ftco-animate wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <a  href="/blog/blog" class="learn-more">
                    ...
                    <div class="ftco-animate wow fadeInUp" data-wow-delay="0.2s">
                        <a href="single.html" class="block-20">
                    ...
                    <div class="ftco-animate wow fadeInUp" data-wow-delay="0.3s">
                        <a href="single.html" class="block-20">
                ...
                <div class="buttom_butt wow fadeInUp" data-wow-delay="0.3s">
                    <a  href="/blog/List" class="cssbuttons-io-button">
                        See More
                        <div class="icon">
                        <svg
                            height="24"
    ...
    <div class="container-xxl pt-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container-xxl pt-5 px-0">
            <div class="bg-dark">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3202.036479117105!2d10.107005!3d36.837789!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1302e4b71c0b5a33%3A0x469c7b573d6c81c5!2s36.837789%2C%2010.107005!5e0!3m2!1sen!2stn!4v1603794290143!5m2!1sen!2sbd" 
                    frameborder="0" 
    ...
    <!-- Map End -->
    <!-- Copyright Start -->
    <div class="container-fluid bg-second text-white py-4">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom text-primary" href="#">Kais Jlassi</a>, All Right Reserved.
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        Designed By <a class="border-bottom text-primary" href="https://oussema-jbeli.netlify.app">Oussema Jbeli</a>
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\Users\OVERLORD\Desktop\kais portfolios\KJ-PORTFOLIO\resources\views/LandingPage.blade.php ENDPATH**/ ?>